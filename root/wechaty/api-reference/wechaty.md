...
| room-invite | `string` | Emit when there is a room invitation, see more in  [RoomInvitation](https://github.com/lijiarui/test-doc/tree/20173d1213c1cc788a75f53384db51e6da014eca/root/wechaty/api/RoomInvitation/README.md)                                    If someone leaves the room by themselves, wechat will not notice other people in the room, so the bot will never get the "leave" event. |
...
| room-invite | `function` | \(this: Wechaty, room: Room, leaverList: Contact\[\]\) =&gt; void                                          see more in  [RoomInvitation](https://github.com/lijiarui/test-doc/tree/20173d1213c1cc788a75f53384db51e6da014eca/root/wechaty/api/RoomInvitation/README.md) |
